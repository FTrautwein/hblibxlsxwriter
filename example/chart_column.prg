...
LOCAL workbook, worksheet, chart, series, bold
    ...
    workbook  = lxw_new_workbook("chart_column.xlsx")
     ...
     */
    chart = lxw_workbook_add_chart(workbook, LXW_CHART_COLUMN_STACKED)
     ...
     */
    chart = lxw_workbook_add_chart(workbook, LXW_CHART_COLUMN_STACKED_PERCENT)
