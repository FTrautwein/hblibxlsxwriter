...
LOCAL workbook, worksheet, chart, series, bold
    ...
    workbook  = lxw_new_workbook("chart_bar.xlsx")
     ...
     * Create a bar chart.
     */
    chart = lxw_workbook_add_chart(workbook, LXW_CHART_BAR)
     ...
     */
    chart = lxw_workbook_add_chart(workbook, LXW_CHART_BAR_STACKED)
     ...
     */
    chart = lxw_workbook_add_chart(workbook, LXW_CHART_BAR_STACKED_PERCENT)
