...
LOCAL workbook, worksheet, chart, series, bold
    ...
    workbook  = lxw_new_workbook("chart_area.xlsx")
     ...
     */
    chart = lxw_workbook_add_chart(workbook, LXW_CHART_AREA_STACKED)
     ...
     */
    chart = lxw_workbook_add_chart(workbook, LXW_CHART_AREA_STACKED_PERCENT)
