...
LOCAL workbook, worksheet, chart, series, bold
    ...
    workbook  = lxw_new_workbook("chart_radar.xlsx")
     ...
     */
    chart = lxw_workbook_add_chart(workbook, LXW_CHART_RADAR)
     ...
     */
    chart = lxw_workbook_add_chart(workbook, LXW_CHART_RADAR_WITH_MARKERS)
     ...
     */
    chart = lxw_workbook_add_chart(workbook, LXW_CHART_RADAR_FILLED)
