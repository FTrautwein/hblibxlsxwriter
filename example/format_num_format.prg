...
function main() 
    ...
    workbook  = lxw_workbook_new("format_num_format.xlsx")
    ...
    lxw_format_set_num_format(format01, "0.000")
    lxw_format_set_num_format(format02, "#,##0")
    lxw_format_set_num_format(format03, "#,##0.00")
    lxw_format_set_num_format(format04, "0.00")
    lxw_format_set_num_format(format05, "mm/dd/yy")
    lxw_format_set_num_format(format06, "mmm d yyyy")
    lxw_format_set_num_format(format07, "d mmmm yyyy")
    lxw_format_set_num_format(format08, "dd/mm/yyyy hh:mm AM/PM")
    lxw_format_set_num_format(format09, '0 "dollar and" .00 "cents"')
